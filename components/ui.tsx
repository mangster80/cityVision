...
export function ProposalGrid({ proposals, compact = false, imageMode = "before", emptyMessage = "Inga förslag ännu.", priorityCount = 0 }: { proposals: Proposal[]; compact?: boolean; imageMode?: "before-after" | "after" | "before"; emptyMessage?: string; priorityCount?: number }) {
