...
import { Building2, LogOut, Menu, Moon, Search, Sun, UserRound, X } from "lucide-react";
...
export function Header() {
  ...
  return <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 sm:px-8"><nav ref={navigationRef} className="glass mx-auto flex max-w-7xl items-center justify-between rounded-2xl px-4 py-3 sm:px-6">
