...
export default function Explore() {
  ...
  const allPlaces = cityService.getPlaces();
  useEffect(() => {
  ...
  const matchingPlaces = useMemo(() => cityService.getPlaces().filter(place => {
  ...
  const matchingProposals = useMemo(() => cityService.getProposals().filter(proposal => {
    const place = cityService.getPlace(proposal.placeId);
