...
export default function ProposalPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const canInvite = Boolean(currentUser?.id && currentUser.id === author.id && !isDemoLoginEnabled());
