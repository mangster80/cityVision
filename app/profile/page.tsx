...
import { ArrowLeft, Heart, MessageCircle, Pencil, ShieldCheck, ThumbsUp } from "lucide-react";
...
function ProfileContent() {
  ...
  return <main className="px-5 pb-20 pt-28 sm:px-8 sm:pt-32"><div className="mx-auto max-w-6xl">
    ...
    {dialog}
    <div className="my-8 grid grid-cols-2 gap-3 sm:grid-cols-4"><div className="rounded-2xl bg-mint p-4 dark:bg-[#292044]"><Heart className="mb-3 text-sage" size={19}/><p className="text-2xl font-semibold"><AnimatedNumber value={ownProposals.length}/></p><p className="text-xs text-slate-500 dark:text-slate-400">{t("profile.proposals-created")}</p></div><div className="rounded-2xl bg-mint p-4 dark:bg-[#292044]"><ThumbsUp className="mb-3 text-sage" size={19}/><p className="text-2xl font-semibold"><AnimatedNumber value={votesReceived}/></p><p className="text-xs text-slate-500 dark:text-slate-400">{t("profile.votes-received")}</p></div><div className="rounded-2xl bg-mint p-4 dark:bg-[#292044]"><Heart className="mb-3 text-sage" size={19}/><p className="text-2xl font-semibold"><AnimatedNumber value={supportedProposals.length}/></p><p className="text-xs text-slate-500 dark:text-slate-400">{t("profile.ideas-supported")}</p></div><div className="rounded-2xl bg-mint p-4 dark:bg-[#292044]"><MessageCircle className="mb-3 text-sage" size={19}/><p className="text-2xl font-semibold"><AnimatedNumber value={commentsReceived}/></p><p className="text-xs text-slate-500 dark:text-slate-400">{t("profile.comments")}</p></div></div>
